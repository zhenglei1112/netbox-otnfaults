...
class StatisticsCableBreakOverviewTestCase(unittest.TestCase):
    ...
    def test_service_cards_render_annual_summary_at_top(self) -> None:
        ...
        self.assertIn("function renderServiceAnnualSummary()", source)
        ...
        self.assertIn('<div class="service-annual-summary-title">年度累计（2026年）</div>', source)
        ...
        self.assertIn("renderServiceAnnualSummary()", source.split('<div class="statistics-strip-card-body">', 1)[1])
        self.assertIn('<div class="service-annual-summary-value">98.8%</div>', source)
        self.assertIn('<div class="service-annual-summary-label">SLA</div>', source)
        self.assertIn('<div class="service-annual-summary-value">56.7时</div>', source)
        self.assertIn('<div class="service-annual-summary-label">中断时长</div>', source)
        self.assertIn('<div class="service-annual-summary-value">7起</div>', source)
    ...
    def test_service_cards_render_runtime_calendar_chart(self) -> None:
        ...
        self.assertIn("function initServiceRuntimeCalendarCharts(container, services)", source)
        ...
        self.assertIn("statistics_dashboard.css' %}?v=28", template)
        self.assertIn("statistics_dashboard.js' %}?v=33", template)
