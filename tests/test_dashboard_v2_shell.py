...
class DashboardV2ShellTestCase(unittest.TestCase):
    ...
    def test_new_page_has_its_own_view_template_and_assets(self) -> None:
        ...
        self.assertIn("?v=20260907-callout-polish-v1", template)
        self.assertIn("app.js' %}?v=20260907-callout-polish-v1", template)
    ...
    def test_app_reads_json_config_and_starts_clock_and_map(self) -> None:
        ...
        self.assertIn("./map_engine.js?v=20260907-callout-polish-v1", source)
        self.assertIn("./frame_rate_limiter.js?v=20260907-callout-polish-v1", source)
        self.assertIn("./data_service.js?v=20260907-callout-polish-v1", source)
        self.assertIn("./debug_panel.js?v=20260907-callout-polish-v1", source)
        self.assertIn("./mock_fault_data.js?v=20260907-callout-polish-v1", source)
        self.assertIn("./info_drawer.js?v=20260907-callout-polish-v1", source)
        self.assertIn("./refresh_controller.js?v=20260907-callout-polish-v1", source)
        self.assertIn("initializeDashboardV2InfoDrawer()", source)
        self.assertIn("./starfield.js?v=20260907-callout-polish-v1", source)
        self.assertIn("./galaxy.js?v=20260907-callout-polish-v1", source)
        self.assertIn("./sky_control.js?v=20260907-callout-polish-v1", source)
        self.assertIn("./day_night_layer.js?v=20260907-callout-polish-v1", source)
        self.assertIn("./day_night_control.js?v=20260907-callout-polish-v1", source)
