...
class DashboardV2ShellTestCase(unittest.TestCase):
    ...
    def test_new_page_has_its_own_view_template_and_assets(self) -> None:
        ...
        self.assertIn("?v=20260904-fault-center-index-v1", template)
        self.assertIn("app.js' %}?v=20260904-fault-center-index-v1", template)
    ...
    def test_app_reads_json_config_and_starts_clock_and_map(self) -> None:
        ...
        self.assertIn("./map_engine.js?v=20260904-fault-center-index-v1", source)
        self.assertIn("./frame_rate_limiter.js?v=20260902-fps-limit-v1", source)
        self.assertIn("./data_service.js?v=20260904-refresh-diff-v2", source)
        self.assertIn("./debug_panel.js?v=20260902-debug-data-v1", source)
        self.assertIn("./mock_fault_data.js?v=20260903-fault-callout-v1", source)
        self.assertIn("./info_drawer.js?v=20260903-fault-callout-v1", source)
        self.assertIn("./refresh_controller.js?v=20260903-refresh-diff-v1", source)
        self.assertIn("initializeDashboardV2InfoDrawer()", source)
        self.assertIn("./starfield.js?v=20260902-bearing-zero-v1", source)
        self.assertIn("./galaxy.js?v=20260902-bearing-zero-v1", source)
        self.assertIn("./sky_control.js?v=20260901-sky-mode-v1", source)
        self.assertIn("./day_night_layer.js?v=20260901-day-night-control-v1", source)
        self.assertIn("./day_night_control.js?v=20260901-day-night-control-v1", source)
        ...
        self.assertIn("fetchDashboardV2Data(config.dataUrl)", source)
        self.assertIn("getDataSignature: createDashboardV2RenderSignature", source)
    ...
    def test_fault_focus_uses_radar_callout_and_reduced_motion_styles(self) -> None:
        css = CSS_PATH.read_text(encoding="utf-8")
        source = MAP_JS_PATH.read_text(encoding="utf-8")
        map_source = MAP_JS_PATH.read_text(encoding="utf-8")
        ...
        self.assertIn("faults.forEach((fault, index) => createProcessingFaultFocus", source)
