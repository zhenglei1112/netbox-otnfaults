...
class StatisticsBranchCompanyTestCase(unittest.TestCase):
    ...
    def test_dashboard_script_renders_branch_company_charts(self) -> None:
        ...
        self.assertIn("branch-performance-annual-metric--emphasis", source)
        self.assertIn("branch-performance-annual-value", source)
        ...
        self.assertIn("branch-performance-company-icon", performance_card_source)
        self.assertIn("mdi-office-building", performance_card_source)
        self.assertIn("branch-performance-title", performance_card_source)
        ...
        self.assertIn("renderBareFiberInterruption(bareFiber, prevBareFiber, 'branch-barefiber');", source)
    ...
    def test_css_defines_branch_company_chart_layout(self) -> None:
        ...
        self.assertIn(".branch-performance-annual-grid", css)
        self.assertIn(".branch-performance-annual-metric", css)
        self.assertIn(".branch-performance-annual-metric--emphasis .branch-performance-annual-value", css)
