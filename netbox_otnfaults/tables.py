...
class OtnFaultTable(NetBoxTable):
    ...
    def render_power_data_type(self, value, record):
        color = record.get_power_data_type_color()
        return format_html('<span class="badge bg-{} text-white">{}</span>', color, record.get_power_data_type_display())
...
class OtnFaultImpactDetailTable(NetBoxTable):
    ...
    class Meta(NetBoxTable.Meta):
        ...
        fields = (
            ...
            'business_impact', 'service_interruption_time', 'service_recovery_time', 'service_duration', 'actions',
        )
        default_columns = (
            'otn_fault', 'fault_category', 'interruption_location_a', 'interruption_location',
...
class OtnFaultImpactSummaryTable(OtnFaultImpactTable):
    ...
    class Meta(OtnFaultImpactTable.Meta):
        fields = (
            ...
            'secondary_faults', 'business_impact', 'actions',
        )
        default_columns = (
            'id', 'service_type', 'service_name',
            'service_interruption_time', 'service_recovery_time', 'service_duration',
            'secondary_faults', 'business_impact',
        )
