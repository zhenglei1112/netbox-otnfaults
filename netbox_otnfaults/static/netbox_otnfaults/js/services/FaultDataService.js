    ...
    return markerData.map((m) => {
      ...
      return {
        ...
        properties: {
          ...
          site: m.a_site || "未指定",
          zSites: m.z_sites || "",
          // 兼容 FaultStatisticsControl 所需的原始字段名
          a_site: m.a_site,
          z_sites: m.z_sites,
          z_site_ids: m.z_site_ids,
          ...
          coordsFromSite: Boolean(m.coords_from_site),
          coords_from_site: Boolean(m.coords_from_site),
          coordsSource: m.coords_source || null,
          coords_source: m.coords_source || null,
          category: category,
          ...
          isLong: Boolean(m.is_long),
          isRepeat: Boolean(m.is_repeat),
          isValidDuration: Boolean(m.is_valid_duration),
          reason: m.reason || "-",
          url: m.url || "#",
          color: categoryColor,
