...
const COLORS_CONFIG =
  (window.OTNFaultMapConfig && window.OTNFaultMapConfig.colorsConfig) || {};
...
// 时间范围选项
// 时间范围选项 (与 LayerToggleControl 保持一致)
window.TIME_RANGE_OPTIONS = [
  { value: "1week", label: "最近1周", days: 7 },
  { value: "2weeks", label: "最近2周", days: 14 },
  { value: "1month", label: "最近1月", days: 30 },
  { value: "3months", label: "最近3月", days: 90 },
  { value: "1year", label: "最近1年", days: 365 },
];
const TIME_RANGE_OPTIONS = window.TIME_RANGE_OPTIONS;
